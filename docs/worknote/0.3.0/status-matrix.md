...
| `R030-DATA` | `in-progress` | [TTL evidence](data-ttl-01/evidence.md), [export-slot correction](data-ttl-01/export-slot-correction.md), [release contract](data-ttl-01/release-contract.md) | P7–P9 implementation/automated evidence complete; repeat packaged compatibility/activation/rollback and final committed-HEAD verification |
