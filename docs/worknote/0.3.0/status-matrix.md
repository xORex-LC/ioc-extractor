...
| `R030-SEC` | `in-progress` | Dependency remediation forward-port from 0.2.1; qualification pending | [Dependency security evidence](evidence/dependency-security.md); remaining security gap analysis |
