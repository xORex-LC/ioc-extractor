...
| `R030-TEST` global controls | `in-progress` | [test-quality ledger](evidence/test-quality-ledger.md) | `TEST-LIFECYCLE-01`, `TEST-COVERAGE-02` and `TEST-REGEX-03` are verified; continue with `TEST-WAITS-04` |
