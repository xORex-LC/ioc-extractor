...
| `R030-DATA` | `analyzed` | [TTL bundle](data-ttl-01/README.md), [architecture project](data-ttl-01/architecture-project.md), [release contract](data-ttl-01/release-contract.md) | Review architecture project and draft ADR/plan, then obtain explicit implementation go-ahead for `DATA-TTL-01/P1` |
...
|---|---|---|---|---|---|---|
| `DATA-TTL-01` | `R030-DATA` | Canonical record expiry across application contracts, SQLite truth/history, active reads, IDs, projection recovery, ingestion duplicates, startup/config/health and packaged activation | P0 decision/plan review; P1–P6 implementation and release closure require separate go-ahead and prohibit partial production activation | AI agent + user review | `analyzed` (`P0` review pending) | [discovery](data-ttl-01/discovery.md), [implementation plan](data-ttl-01/implementation-plan.md), [ADR-0020](../../ADR/0020-canonical-record-expiration-lifecycle.md) |
