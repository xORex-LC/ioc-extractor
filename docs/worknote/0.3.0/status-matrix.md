...
| `DATA-IMPORT-01` | `R030-DATA` | Managed local/SMB structured dataframe deliveries into SQLite truth; versioned recognition/mapping, active-only patch, atomic promotion and recovery | P0 contract/boundary baseline implemented and working-tree verified: accepted ADR, framework-free model/compiler/ports, disabled strict config, match-key declarations, TCK skeletons and dependency guards; P1 runtime preparation not started | AI agent + user review | `in-progress` (`P0 complete; P1 pending`) | [P0 evidence](dataframe-import/p0-evidence.md), [architecture](dataframe-import/architecture-project.md), [release contract](dataframe-import/release-contract.md), [implementation plan](dataframe-import/implementation-plan.md), [verification matrix](dataframe-import/verification-matrix.md), [ADR-0024](../../ADR/0024-managed-dataframe-import.md) |
