...
| `R030-TEST` global controls | `in-progress` | [test-quality ledger](evidence/test-quality-ledger.md) | `TEST-LIFECYCLE-01` through `TEST-PILOTS-06` are verified; continue with best-effort non-required `TEST-CODECOV-07` |
