...
| `R030-TEST` global controls | `in-progress` | [test-quality ledger](evidence/test-quality-ledger.md) | `TEST-LIFECYCLE-01`, `TEST-COVERAGE-02`, `TEST-REGEX-03` and `TEST-WAITS-04` are verified; continue with `TEST-EXTERNAL-05` |
