...
| `R030-BUILD` | `in-progress` | [build-quality ledger](evidence/build-quality-ledger.md) | Resume `BUILD-SPOTBUGS-04/C3` from the verified `ING-10`/`IR-03` predecessor and reconciled 122-finding report |
