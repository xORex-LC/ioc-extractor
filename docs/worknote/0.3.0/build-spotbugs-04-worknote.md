...
| `C3` | Fix and baseline | Immediate risks исправлены; оставшиеся findings покрыты узкими reviewed selectors | `not-started; approved ING-10/IR-03 predecessor runs first` |
...
| `SB04-040` | `ioc-adapter-ingest` | `EI_EXPOSE_REP` | `com.iocextractor.adapter.in.ingest.IngestAdapterProperties$Patterns#exclude` | P2 / `MALICIOUS_CODE` | Accessor возвращает исходный mutable binding list; production consumers только читают его. `d7b323f87c0fe0cd9d2cbcd2804b919f/0` | `accepted-legacy` | `C2-REP-A` | `triaged` |
| `SB04-041` | `ioc-adapter-ingest` | `EI_EXPOSE_REP` | `com.iocextractor.adapter.in.ingest.IngestAdapterProperties$Patterns#include` | P2 / `MALICIOUS_CODE` | Та же adapter-binding alias: copy отсутствует, mutation call sites отсутствуют. `f3cce6cb4dfc6da92a161cdb3916c94a/0` | `accepted-legacy` | `C2-REP-A` | `triaged` |
| `SB04-042` | `ioc-adapter-sink-csv` | `EI_EXPOSE_REP` | `com.iocextractor.adapter.out.sink.csv.ColumnSpec#transform` | P2 / `MALICIOUS_CODE` | Adapter value record сохраняет и возвращает caller-owned transform list без копии. `2d16b6f136eda7e47a5e5c980b8f81b1/0` | `accepted-legacy` | `C2-REP-B` | `triaged` |
...
| `SB04-044` | `ioc-adapter-sink-csv` | `EI_EXPOSE_REP` | `com.iocextractor.adapter.out.sink.csv.CsvArtifactDefinition#accepts` | P2 / `MALICIOUS_CODE` | Public adapter definition возвращает caller-owned mutable set; production wiring передаёт новый `EnumSet`. `4a3413116ff21ad06360898deb8cc6ee/0` | `accepted-legacy` | `C2-REP-B` | `triaged` |
...
| `SB04-046` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties#patterns` | P2 / `MALICIOUS_CODE` | Root configuration record хранит и возвращает binding map без `Map.copyOf`; runtime callers только читают. `e514ebe6ae8e6497319b778ed8a32c59/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-047` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$ArtifactIdentity#artifacts` | P2 / `MALICIOUS_CODE` | Configuration list alias сохраняется после binding; mutation consumers не найдены. `321d59427789ab8d26d2e8c7d5cc9535/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-048` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$ArtifactIdentity$Artifact#keyColumns` | P2 / `MALICIOUS_CODE` | Identity key-column list не копируется на record boundary. `21898152d6e6d95f5c7f99eaf4ce3c0d/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-049` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Classify#rules` | P2 / `MALICIOUS_CODE` | Classify rules остаются caller-owned после binding. `9b30fa71c0d8a8dddad035e4e509f075/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-050` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Classify$Rule#when` | P2 / `MALICIOUS_CODE` | Predicate-key list возвращается без defensive copy. `4a52f37d7e1f686b57bba129534e0e63/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-051` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Export#profiles` | P2 / `MALICIOUS_CODE` | Export profile binding list не копируется; downstream plan model копирует уже разрешённое значение. `4803fec7397c4f66e5f6c11029ce35e/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-052` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Export$Profile#artifacts` | P2 / `MALICIOUS_CODE` | Profile artifact list остаётся mutable до разрешения в immutable `ExportProfile`. `e54252e74bad4dd5fc6d8efdf60cf08b/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-053` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Ingestion$Patterns#exclude` | P2 / `MALICIOUS_CODE` | Bootstrap ingestion exclusion list доступен как исходный binding list. `32750f92d56af54271412579aeaa13b/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-054` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Ingestion$Patterns#include` | P2 / `MALICIOUS_CODE` | Bootstrap ingestion include list доступен как исходный binding list. `c979f70e1e210a5e83ec74c753cd77aa/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-055` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Maintenance$Retention#targets` | P2 / `MALICIOUS_CODE` | Retention target list не копируется на config boundary. `4383028711e091ec3fa3830bcd139efc/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-056` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Refang#rules` | P2 / `MALICIOUS_CODE` | Ordered refang rules сохраняют mutable alias после binding. `11a462629da63283350d0221a37f6592/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-057` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink#artifacts` | P2 / `MALICIOUS_CODE` | Sink artifact list хранится и выдаётся без copy. `27f968e5458e541f71621c1e4ea4e628/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-058` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#accepts` | P2 / `MALICIOUS_CODE` | Accepted-type list остаётся caller-owned до adapter assembly. `d427c73f23b7f225acef3a345a6e5c0a/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-059` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#columns` | P2 / `MALICIOUS_CODE` | Column definition list не копируется на config boundary. `17d6c50b951ca7086aa4740028b55003/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-060` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#exclude` | P2 / `MALICIOUS_CODE` | Exclusion-key list возвращает mutable binding representation. `5d1273b759b27055d9e869e41a9b17b4/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-061` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#include` | P2 / `MALICIOUS_CODE` | Inclusion-key list возвращает mutable binding representation. `b9bf50e4732ccab46011395c7b6bf22d/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-062` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact$Column#transform` | P2 / `MALICIOUS_CODE` | Transform list остаётся caller-owned до преобразования в adapter spec. `4c232ba4bc3cebc68710c0ed9d38965d/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-063` | `ioc-app` | `EI_EXPOSE_REP` | `com.iocextractor.bootstrap.IocProperties$Source#sectionMarkers` | P2 / `MALICIOUS_CODE` | Ordered section-marker list не копируется после binding. `adc0bb370c48470cb26ddf361beac388/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
...
| `SB04-067` | `ioc-adapter-ingest` | `EI_EXPOSE_REP2` | `com.iocextractor.adapter.in.ingest.IngestAdapterProperties$Patterns#<init>` | P2 / `MALICIOUS_CODE` | Constructor сохраняет caller-owned exclusion list без copy. `17412f59916541b9d5ca32f457b6a8cd/0` | `accepted-legacy` | `C2-REP-A` | `triaged` |
| `SB04-068` | `ioc-adapter-ingest` | `EI_EXPOSE_REP2` | `com.iocextractor.adapter.in.ingest.IngestAdapterProperties$Patterns#<init>` | P2 / `MALICIOUS_CODE` | Constructor сохраняет caller-owned include list без copy. `88e2ccc27ed7e7f2f82d9ac814ffea3/0` | `accepted-legacy` | `C2-REP-A` | `triaged` |
| `SB04-069` | `ioc-adapter-sink-csv` | `EI_EXPOSE_REP2` | `com.iocextractor.adapter.out.sink.csv.ColumnSpec#<init>` | P2 / `MALICIOUS_CODE` | Constructor сохраняет caller-owned transform list; null является допустимым DSL value. `2bf452c6c68175ca31a4d07c6999de09/0` | `accepted-legacy` | `C2-REP-B` | `triaged` |
| `SB04-070` | `ioc-adapter-sink-csv` | `EI_EXPOSE_REP2` | `com.iocextractor.adapter.out.sink.csv.CsvArtifactDefinition#<init>` | P2 / `MALICIOUS_CODE` | Constructor нормализует filter, но не копирует accepted-type set. `2bd885fc321365e00b5fabc59e140fb0/0` | `accepted-legacy` | `C2-REP-B` | `triaged` |
| `SB04-071` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties#<init>` | P2 / `MALICIOUS_CODE` | Root constructor не копирует pattern map; null-sensitive JSR-380 contract запрещает безусловный `copyOf`. `b6ea00cf7c6b9d964b88d6142d511e6/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-072` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$ArtifactIdentity#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable artifacts list. `279b2871263c8502cf91d7b8e2ec5132/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-073` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$ArtifactIdentity$Artifact#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable key-column list. `c13f2d23621b7d3dd2b18988d1358150/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-074` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Classify#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable classify rules. `a5c71d9670bee8cbca61f047c3da5bc4/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-075` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Classify$Rule#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable predicate-key list. `c95ad42837f4e593501b3b1276bf021e/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-076` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Export#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable profile list. `476e975b78f8152b0da50dfd6774f72f/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-077` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Export$Profile#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable artifact-name list. `bda497677a1a86320cf68cf82534ba9d/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-078` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Ingestion$Patterns#<init>` | P2 / `MALICIOUS_CODE` | Bootstrap constructor сохраняет mutable exclusion list. `36f9394efd2d07bc84c0e9ea533003ea/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-079` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Ingestion$Patterns#<init>` | P2 / `MALICIOUS_CODE` | Bootstrap constructor сохраняет mutable include list. `ed34a5d726816821b78119a175de0913/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-080` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Maintenance$Retention#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable retention targets. `3de8b959c89295faac211c39b948445c/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-081` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Refang#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable ordered rules. `3177dc591e440a55446721d5926e57fc/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-082` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable sink artifacts. `b720c3dff4492ac9d359726495118b75/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-083` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#<init>` | P2 / `MALICIOUS_CODE` | Один constructor instance относится к accepted-type list; copy отсутствует. `4d9396086518b83baab8fa6b39604287/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-084` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#<init>` | P2 / `MALICIOUS_CODE` | Один constructor instance относится к column list; copy отсутствует. `d6ddc20d9e59bf25fa986b6ab8a9fd73/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-085` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#<init>` | P2 / `MALICIOUS_CODE` | Один constructor instance относится к exclusion-key list; copy отсутствует. `dc6e5c5a30c2034dc1fcfbe52f80033b/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-086` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact#<init>` | P2 / `MALICIOUS_CODE` | Один constructor instance относится к inclusion-key list; copy отсутствует. `f7e956c34c1a1c2bbfeb41850e1d486/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-087` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Sink$Artifact$Column#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет nullable mutable transform list. `4678fb3055ceebe0db3781e8b468f6b1/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-088` | `ioc-app` | `EI_EXPOSE_REP2` | `com.iocextractor.bootstrap.IocProperties$Source#<init>` | P2 / `MALICIOUS_CODE` | Binding constructor сохраняет mutable section-marker list. `9f860ec6e5c40a8722baca122d16f073/0` | `accepted-legacy` | `C2-REP-D` | `triaged` |
| `SB04-089` | `ioc-adapter-cli-picocli` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.adapter.in.cli.ExportCommand#call` | P3 / `BAD_PRACTICE` | Logs the failure and rethrows the same runtime exception to the Picocli boundary. `3715419b138a600afca4c34bc44a6f39/0` | `false-positive` | `C2-EX-A` | `triaged` |
| `SB04-090` | `ioc-adapter-cli-picocli` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.adapter.in.cli.ExtractCommand#call` | P3 / `BAD_PRACTICE` | Same CLI exception contract: mandatory log side effect, then unchanged propagation. `81595ad9b11bb20d5c3e2e4d618ce772/0` | `false-positive` | `C2-EX-A` | `triaged` |
| `SB04-091` | `ioc-adapter-transport-smb` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.adapter.out.transport.smb.SmbFileTransport#publish` | P3 / `BAD_PRACTICE` | Failure path removes the remote temporary file, then preserves the primary runtime exception. `94ece55bd8105af5894ae60a0ce84620/0` | `false-positive` | `C2-EX-B` | `triaged` |
| `SB04-092` | `ioc-app` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.bootstrap.LazyServiceStorage#initialize` | P3 / `BAD_PRACTICE` | Initialization failure closes only the newly created datasource before rethrowing unchanged. `11e546190d2ff6319722be2f26d54f11/0` | `false-positive` | `C2-EX-B` | `triaged` |
| `SB04-093` | `ioc-app` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.bootstrap.RemoteChangeFetchListener#fetch` | P3 / `BAD_PRACTICE` | Listener records health failure and intentionally propagates it into the keyed executor. `140f08d5e49e74e14a6a25c2a81899a/0` | `false-positive` | `C2-EX-C` | `triaged` |
| `SB04-094` | `ioc-app` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.bootstrap.RemoteChangeWatchLifecycle#start` | P3 / `BAD_PRACTICE` | Partial-start failure closes already-started watches and preserves the original failure. `469a442a692cb759cd32c619ab888ca0/0` | `false-positive` | `C2-EX-B` | `triaged` |
| `SB04-095` | `ioc-app` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.bootstrap.SliceCompletedPublishListener#publish` | P3 / `BAD_PRACTICE` | Listener records observer state and rethrows into the shared keyed-execution boundary. `e42c3c0853dd29c53834f3c4cb10de8c/0` | `false-positive` | `C2-EX-C` | `triaged` |
| `SB04-096` | `ioc-application` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.application.ingest.IngestionService#processClaimed` | P3 / `BAD_PRACTICE` | Failure path durably marks the run failed before propagating the original exception. `7a89ba4685786a19ea93a39df38a53f1/0` | `false-positive` | `C2-EX-B` | `triaged` |
| `SB04-097` | `ioc-application` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.application.ingest.IngestionService#recoverIncomplete` | P3 / `BAD_PRACTICE` | Recovery preserves an existing diagnostic-bearing runtime failure after required accounting. `1073f127fb3e9ae67c97ccba01a43fa/0` | `false-positive` | `C2-EX-D` | `triaged` |
| `SB04-098` | `ioc-application` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.application.ingest.IngestionService#recoverIncomplete` | P3 / `BAD_PRACTICE` | Non-diagnostic runtime failures are translated once with the original cause retained. `1073f127fb3e9ae67c97ccba01a43fa/1` | `false-positive` | `C2-EX-D` | `triaged` |
| `SB04-099` | `ioc-application` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.application.sync.RemoteFetchService#fetchOne` | P3 / `BAD_PRACTICE` | Failed fetch removes its staging file, then propagates the same runtime failure. `5b4c8c3522a8c9b5fc449feff65e94e9/0` | `false-positive` | `C2-EX-B` | `triaged` |
| `SB04-100` | `ioc-platform-etl` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.platform.etl.PipelineRunner#emitSuppressionSummary` | P3 / `BAD_PRACTICE` | Summary emission does not replace or mask an already established primary failure. `55f447907b635a14f17b160bb4ee9e20/0` | `false-positive` | `C2-EX-E` | `triaged` |
| `SB04-101` | `ioc-platform-etl` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.platform.etl.PipelineRunner#executeInRunScope` | P3 / `BAD_PRACTICE` | Run-scope cleanup preserves the primary unchecked stage failure and its stack. `bffd062e9915fa3e76d30e8510c74f45/0` | `false-positive` | `C2-EX-E` | `triaged` |
| `SB04-102` | `ioc-platform-etl` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.platform.etl.PipelineRunner#executeInRunScope` | P3 / `BAD_PRACTICE` | Checked `AutoCloseable` failure is separated from unchecked execution failure without losing cause. `bffd062e9915fa3e76d30e8510c74f45/1` | `false-positive` | `C2-EX-E` | `triaged` |
| `SB04-103` | `ioc-platform-etl` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.platform.etl.PipelineRunner#executeInRunScope` | P3 / `BAD_PRACTICE` | Alternate cleanup branch retains the primary runtime exception and suppression order. `bffd062e9915fa3e76d30e8510c74f45/2` | `false-positive` | `C2-EX-E` | `triaged` |
| `SB04-104` | `ioc-platform-etl` | `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` | `com.iocextractor.platform.etl.PipelineRunner#runWithOutcome` | P3 / `BAD_PRACTICE` | Observer/accounting failure handling deliberately preserves the original unchecked contract. `304748d9178334ff7558bfff33701d2d/0` | `false-positive` | `C2-EX-E` | `triaged` |
| `SB04-105` | `ioc-adapter-transport-smb` | `BC_UNCONFIRMED_CAST_OF_RETURN_VALUE` | `com.iocextractor.adapter.out.transport.smb.SmbjChangeNotifySessionFactory#open` | P3 / `STYLE` | SMBJ returns raw `Share`; a non-disk share causes `ClassCastException` and is currently classified transient. `bf73ded51595f0753a7623e7e67a0d9d/0` | `accepted-legacy` | `C2-MIX-A` | `triaged` |
| `SB04-106` | `ioc-adapter-transport-smb` | `BC_UNCONFIRMED_CAST_OF_RETURN_VALUE` | `com.iocextractor.adapter.out.transport.smb.SmbjShareClientFactory#open` | P3 / `STYLE` | Same unconfirmed SMBJ share-type contract and misleading retry taxonomy on configuration error. `5ecd53a230db10168007d19f7ab511b1/0` | `accepted-legacy` | `C2-MIX-A` | `triaged` |
| `SB04-107` | `ioc-platform-diagnostics` | `CT_CONSTRUCTOR_THROW` | `com.iocextractor.diagnostics.DiagnosticException#<init>` | P2 / `BAD_PRACTICE` | Public non-final exception validates null, but no subclass or untrusted extension boundary exists. `c5d8d97ed68c1e802a05a8641c122513/0` | `accepted-legacy` | `C2-MIX-B` | `triaged` |
| `SB04-108` | `ioc-adapter-store-jdbc` | `DB_DUPLICATE_SWITCH_CLAUSES` | `com.iocextractor.adapter.out.store.jdbc.JdbcPublishLedger#requireTransition` | P3 / `STYLE` | `PENDING` and `FAILED` branches are behaviorally identical; real local DRY debt. `fc72f0cd33f6875eefdc46492ca2ebdb/0` | `accepted-legacy` | `C2-MIX-C` | `triaged` |
| `SB04-109` | `ioc-adapter-sink-csv` | `DLS_DEAD_LOCAL_STORE_OF_NULL` | `com.iocextractor.adapter.out.sink.csv.CsvSliceMaterialization#beginArtifact` | P3 / `STYLE` | Redundant `stream = null`; catch path already closes the printer that owns it. `9bb6d5a90d0adb82eee2487e06e36986/0` | `accepted-legacy` | `C2-MIX-C` | `triaged` |
| `SB04-110` | `ioc-app` | `DM_CONVERT_CASE` | `com.iocextractor.bootstrap.LoggingPipelineDecisionTracer#identity` | P3 / `I18N` | Machine-readable log identity depends on default locale instead of `Locale.ROOT`. `efd060cca1593aff8e79b4d9d322cad5/0` | `accepted-legacy` | `C2-MIX-D` | `triaged` |
| `SB04-111` | `ioc-application` | `DM_CONVERT_CASE` | `com.iocextractor.application.ingest.SourceKey#<init>` | P3 / `I18N` | Public value normalization is locale-sensitive; current production keys are lowercase hex or `recovery-scan`. `5f8022e53204730ff75bf5cbf2483fcc/0` | `accepted-legacy` | `C2-MIX-D` | `triaged` |
| `SB04-112` | `ioc-application` | `DM_CONVERT_CASE` | `com.iocextractor.application.pipeline.stage.ExtractIndicatorsStage#lambda$trace$0` | P3 / `I18N` | Enum-derived trace token should use locale-neutral case conversion. `13693251420f8991d7cb5b687d971fee/0` | `accepted-legacy` | `C2-MIX-D` | `triaged` |
| `SB04-113` | `ioc-adapter-cli-picocli` | `REC_CATCH_EXCEPTION` | `com.iocextractor.adapter.in.cli.HealthCommand#parse` | P3 / `STYLE` | Fail-soft raw fallback is intended, but broad `Exception` also masks unrelated runtime defects. `1ad4dc55569667eed6a663165263ecc7/0` | `accepted-legacy` | `C2-MIX-E` | `triaged` |
| `SB04-114` | `ioc-adapter-cli-picocli` | `REC_CATCH_EXCEPTION` | `com.iocextractor.adapter.in.cli.HealthCommand#prettyOrRaw` | P3 / `STYLE` | Same intentional fallback with an unnecessarily broad catch contract. `ab571868a64e58fa53c90804901eefd8/0` | `accepted-legacy` | `C2-MIX-E` | `triaged` |
...
| `SB04-116` | `ioc-adapter-store-jdbc` | `UPM_UNCALLED_PRIVATE_METHOD` | `com.iocextractor.adapter.out.store.jdbc.JdbcIngestionLedger#inTransaction` | P3 / `PERFORMANCE` | Dead transaction helper exposes a false single-writer assumption: `ING-10` permits recovery/poller overlap while terminal transitions are blind find-then-update. `9a17a9287388b204002e5eaaca17d43c/0` | `fix-now` | `IR-03` | `triaged; queue reordered before C3` |
...
| `SB04-118` | `ioc-app` | `VA_FORMAT_STRING_USES_NEWLINE` | `com.iocextractor.bootstrap.IocConfigurationFailureAnalyzer#description` | P2 / `BAD_PRACTICE` | Operator-facing description fixes LF while action uses platform separator, producing mixed output off Unix. `4546273d871867e68096f7b01f563efb/0` | `accepted-legacy` | `C2-MIX-H` | `triaged` |
...
Из 49 `EI_EXPOSE_REP*` findings 44 обозначают реальные mutable aliases, но
текущий production call graph их только читает. Это не immediate security/data
risk, однако это legacy debt относительно project convention об immutable value
objects и defensive copy на входе. Пять остальных случаев имеют доказанный
immutable либо lifecycle/DI ownership contract и классифицированы как false
positive.

| Evidence ref | Finding IDs | Semantic evidence | Disposition, owner and exit condition |
|---|---|---|---|
| `C2-REP-A` | `SB04-040..041`, `SB04-067..068` | Adapter-bound include/exclude lists сохраняются и возвращаются без copy; mutation call sites отсутствуют | `accepted-legacy`; owner `adapter-ingest`; exit — null-preserving `List.copyOf` и binder/alias regression tests |
| `C2-REP-B` | `SB04-042`, `SB04-044`, `SB04-069..070` | CSV adapter records удерживают caller-owned transform list/accepted-type set | `accepted-legacy`; owner `adapter-sink-csv`; exit — nullable copy для transform, `Set.copyOf` для accepts и mutation-isolation tests |
...
| `C2-REP-D` | `SB04-046..063`, `SB04-071..088` | Spring-bound `IocProperties` records сохраняют collection/map aliases; downstream code не мутирует их | `accepted-legacy`; owner `ioc-app/configuration`; exit — null-preserving copies, не нарушающие ADR-0016 collect-all validation, плюс binding/validation regressions |
...
Конкретный порядок fixes/baseline для этих групп остаётся решением `C3`.

### C2 exception-flow evidence

Все 16 `THROWS_METHOD_THROWS_RUNTIMEEXCEPTION` findings — false positives в
действующих contracts. Каждый catch выполняет обязательное cleanup,
health/observer update, durable accounting либо translation, после чего
сохраняет исходный runtime type, stack и cause. Swallowed exception или потеря
первичной ошибки не обнаружены.
...
| `C2-EX-B` | `SB04-091..092`, `SB04-094`, `SB04-096`, `SB04-099` | Failure path сначала закрывает/удаляет частично созданный ресурс либо фиксирует failed run, затем rethrow | Cleanup начинает маскировать primary failure или становится asynchronous |
| `C2-EX-C` | `SB04-093`, `SB04-095` | Event listener обновляет health/observer и propagates failure в keyed executor | Executor получает новый retry/swallow contract |
...
| `C2-EX-E` | `SB04-100..104` | `PipelineRunner` разделяет primary unchecked failure и checked close/summary failures, не позволяя вторичным ошибкам маскировать первичную | Меняется run-scope/observer/suppression protocol |

### C2 mixed-pattern evidence

| Evidence ref | Finding IDs | Semantic evidence | Disposition and exit condition |
|---|---|---|---|
| `C2-MIX-A` | `SB04-105..106` | SMBJ `Session.connectShare` возвращает общий `Share` и может создать disk, pipe или printer share; прямой cast на `DiskShare` превращает неверный share type в `ClassCastException`, сейчас классифицируемый как transient | `accepted-legacy`; заменить на typed check, выбрать permanent configuration taxonomy и закрепить тестом |
| `C2-MIX-B` | `SB04-107` | `DiagnosticException` public/non-final и constructor может отклонить null, но subclasses и untrusted extension boundary отсутствуют | `accepted-legacy`; сделать exception final и закрепить null contract либо принять точный baseline |
| `C2-MIX-C` | `SB04-108..109` | Одинаковые switch branches и dead `stream = null` — реальный локальный DRY/dead-store debt без behavioral impact | `accepted-legacy`; объединить cases и удалить store после focused transition/resource regressions |
| `C2-MIX-D` | `SB04-110..112` | Machine tokens/value normalization зависят от default locale; текущие production `SourceKey` состоят из lowercase hex или `recovery-scan` | `accepted-legacy`; использовать `Locale.ROOT`, закрепив Turkish-locale tests для публичного value contract и emitted tokens |
| `C2-MIX-E` | `SB04-113..114` | Health CLI намеренно fail-soft возвращает raw payload, но `catch (Exception)` также скрывает unrelated runtime defects | `accepted-legacy`; сузить catch до Jackson failures и проверить parse/raw fallback |
...
| `IR-03` | `SB04-116` | Неиспользуемые `TransactionTemplate`/`inTransaction` соседствуют с комментарием о single writer; `ING-10` доказывает возможный overlap startup recovery и poller, тогда как terminal transitions выполняют blind find→update без expected state/CAS | `fix-now`; не «подключать helper», а совместно закрыть lifecycle barrier, per-source-key serialization и atomic/CAS transition semantics до `C3`; queue reorder утверждён |
...
| `C2-MIX-H` | `SB04-118` | Failure description использует fixed LF, action — platform separator, что даёт mixed formatting вне Unix | `accepted-legacy`; перейти на `%n`/`System.lineSeparator` и закрепить analyzer output test |
...
| `SB04-116` (`IR-03`) | File-ledger terminal state can be overwritten or left stale when startup recovery and poller overlap; unused transaction helper reveals, but does not solve, the invalid single-writer assumption | `JdbcIngestionLedger` performs find→write transitions without expected-state/CAS; live startup wiring and documented `ING-10` permit two lifecycle branches despite poller `concurrency: 1` | Combine `ING-10` lifecycle barrier and per-source-key serialization with atomic/CAS ledger transitions; do not merely invoke the dead helper | Concurrent two-writer ledger characterization, expected-state transition tests and daemon startup recovery/poller regression, then full verify | Confirmed correctness/concurrency risk; no new canonical-data-loss evidence; approved predecessor to `C3` |
...
| 2026-08-01 | `D-010` | `C2` | `SB04-040..118` полностью triaged: 55 accepted legacy, 23 false positives и 1 fix-now. Representation review отделил 44 real aliases от 5 immutable/lifecycle-owned exposures; все 16 exception-flow findings сохраняют primary runtime failure после обязательного cleanup/accounting | Не создавать baseline до `C3`; для mutable config records сохранить ADR-0016 null/collect-all contract |
...
|---|---|---|---|---|
| `C0-C2 evidence` | Reproducible inventory, full semantic triage и SQL trust-boundary hardening | worknote, build-quality ledger, status matrix, KNOWN-ISSUES; six JDBC security regression cases, focused module runs and canonical verification | — | uncommitted |
