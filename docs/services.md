...
| **CanonicalArtifactRepository** | чтение/атомарная запись canonical artifact rows | `CanonicalArtifactRepository` | artifact rows ↔ DB | Spring JDBC/sqlite | adapter | `adapter-store-jdbc` |
