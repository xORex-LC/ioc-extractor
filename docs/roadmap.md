...
| 12 | Artifact Emission ([dev/0012](dev/0012-streaming-dataframe-emission.md)): strict snapshot, immutable profile slices, export saga/recovery, cadence, health, retention | 11 | CLI + daemon; concurrent write не рвёт snapshot; marker/hash-chain; crash recovery; golden slice | `./mvnw -B -ntp -T 1C verify` |
...
| 12 immutable artifact emission | `done` |
