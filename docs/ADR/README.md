...
| `0020-canonical-record-expiration-lifecycle.md` | Lifecycle TTL принадлежит canonical artifact record; exact active-read predicate, bounded history/reconciliation, monotonic IDs, explicit one-way legacy activation, clock safety и duplicate-receipt fallback образуют один согласованный data-quality contract. Existing public schemas остаются неизменными. **Черновик от 2026-08-15; проходит architecture review, не принят и не реализован.** |
