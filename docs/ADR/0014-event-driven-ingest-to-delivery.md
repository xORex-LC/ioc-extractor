...
План ниже — execution checklist для имплементации. Срезы можно выполнить за один
агентский проход, но коммитить лучше логическими группами: Р1 отдельно, Р2 —
сначала событие/эмиссия, затем consumer/nudge+wiring. Все срезы сохраняют
...
Если при реализации всё выполняется за один агентский проход, срезы 3 и 4 можно
