...
/**
 * A declaratively configured directory the reaper maintains (e.g. {@code done},
 * {@code failed}). The same policy serves all of them; only these
 * parameters differ.
 *
 ...
 * @param maxCount   keep at most this many newest entries; {@code <= 0} disables count-based reaping
