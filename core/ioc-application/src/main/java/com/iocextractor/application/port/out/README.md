...
| `ingest/` | Driven-порты source lifecycle, ledger и partition sink factory |
| `aggregation/` | Driven-порты partition/canonical storage, identity resolver и stable id index |
