...
public enum LogField {
    ...
    IOC_IMPORT_DISPOSITION("ioc.import.disposition", LogValueType.STRING,
            "Safe managed import destination class: terminal or quarantine."),
    IOC_IMPORT_FAILURE_REASON("ioc.import.failure_reason", LogValueType.STRING,
            "Stable value-free reason for a managed import terminal failure."),
