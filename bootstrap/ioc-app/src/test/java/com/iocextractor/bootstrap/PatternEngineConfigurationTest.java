...
class PatternEngineConfigurationTest {
    ...
    private static List<PatternCase> sectionMarkerCases() {
        return List.of(
                ...
                new PatternCase("До Заявка_6619 после", "Заявка_6619", "До Заявка_X после"),
                new PatternCase(
                        "До ФСТЭК_02.04.2026_240/93/2124 после",
                        "ФСТЭК_02.04.2026_240/93/2124",
                        "До ФСТЭК_02-04-2026_240/93/2124 после"),
                new PatternCase(
                        "До ФСТЭК 21.05.2025 №240/93/1329 после",
                        "ФСТЭК 21.05.2025 №240/93/1329",
                        "До ФСТЭК 21-05-2025 №240/93/1329 после"),
                new PatternCase(
