...
public record ArtifactIdAllocatorDefinition(String artifact,
                                            ArtifactIdStrategy strategy,
                                            long configuredNextValue,
                                            long identityEpoch) {

    /** Validates the configured artifact identity and allocation direction. */
    public ArtifactIdAllocatorDefinition {
